...
$DATABASE_NAME = 'epiz_33178929_phpnewsletters';  //use same database name for easy setup bro
			...
			<div>
				...
				<table>
					...
					<tr>
						<td>Password:</td>
						<td><?=$password?></td>
						<td>Come on! Obviously We Wouldn't Show Your Password As It Is :)  </td>
					</tr>
					<tr>
						<td>Email:</td>
						<td><?=$email?></td>
